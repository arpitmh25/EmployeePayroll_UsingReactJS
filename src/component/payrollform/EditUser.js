...
//Created for editing user details
const initialValue = {
    "name": '',
    "gender": '',
    "departments": [],
...
const EditUser = (props) => {
    ...
    const { name, gender, departments, salary, startdate, notes, profilePic } = user;
    const { id } = useParams();
            ...
            <div className="form-content">
                <form className="form-head" action="#" onSubmit={save}>
                    ...
                    <div className="row-content">
                        ...
                        <textarea onChange={(event) => { changeValue(event); console.log(notes); console.log(event.target.value); }} id="notes" value={notes} className="input" name='notes' placeholder=""
                    ...
                    <div className="buttonParent">
                        ...
                        <div className="submit-reset">
                            ...
                            <button type="submit" onClick={() => editUserDetails(id)} className="button submitButton" id="submitButton">{formValue.isUpdate ? 'Update' : 'Submit'}</button>
